...
public class GvrReticlePointer : GvrBasePointer {
  ...
  public override void OnPointerEnter(RaycastResult raycastResultResult, bool isInteractive) {
    SetPointerTarget(raycastResultResult.worldPosition, isInteractive);
        ...
        if (gazeAt.gameObject.name == "MediaPlay") {

            gazeAt.gameObject.transform.parent.GetComponent<MediaPlaypause>().clicked = false;
            gazeAt.gameObject.transform.parent.GetComponent<MediaPlaypause>().PlayAndPause();
            Debug.Log(gazeAt.gameObject.name + ":::::");
        }
        if (gazeAt.gameObject.name == "MenuHotspot")
        {
            gazeAt.gameObject.transform.GetComponent<MenuHotspot>().ClickOnVisible();
            Debug.Log(gazeAt.gameObject.name + ":::::");
        }

        if (gazeAt.gameObject.name == "Display text lable")
        {
            gazeAt.gameObject.transform.GetComponent<HideInfo>().OnMouseOver();
            Debug.Log(gazeAt.gameObject.name + ":::::");
        }
    }
  ...
  public override void OnPointerExit(GameObject previousObject) {
    ...
    ReticleOuterAngle = RETICLE_MIN_OUTER_ANGLE;
        ...
        if (gazeAt.gameObject.name == "Display text lable")
        {
            gazeAt.gameObject.transform.GetComponent<HideInfo>().OnMouseExit();
            Debug.Log(gazeAt.gameObject.name + ":::::");
        }
