...
public class NewActionHotspot : MonoBehaviour {  
	...
	void Update ()
	{
		...
		if (gameObject.transform.localPosition.z == 0)
            {
				gameObject.transform.localPosition = new Vector3 (gameObject.transform.localPosition.x, gameObject.transform.localPosition.y, 90f);
...
//							MediaFlag.Add (flagOptionMediaEmty);
	...
	//	MediaFilePrb.transform.localPosition = new Vector3(0,0,90);  
