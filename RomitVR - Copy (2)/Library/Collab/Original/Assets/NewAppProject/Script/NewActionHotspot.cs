...
//							MediaFlag.Add (flagOptionMediaEmty);
    ...
    { 
		...
		gameObject.transform.GetChild (1).gameObject.transform.GetChild (1).transform.GetComponent<Image> ().color = Color.green;  
    ...
    {  
		...
		gameObject.transform.GetChild (1).gameObject.transform.GetChild (0).transform.GetComponent<Image> ().color =  Color.green;       
		GameObject.Destroy (gameObject.transform.GetChild (0).gameObject);        
	}
